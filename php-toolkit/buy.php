...
error_reporting(E_ALL);
   ...
   $Pipe->setResponseURL("https://ecom.fantasyworldtoys.com/fantasyworldtoys/php-toolkit/response.php"); // set your respone page URL
   $Pipe->setErrorURL("https://ecom.fantasyworldtoys.com/fantasyworldtoys/php-toolkit/error.php"); //set your error page URL
   $Pipe->setAmt("10"); //set the amount for the transaction
   //$Pipe->setResourcePath("/Applications/MAMP/htdocs/php-toolkit/resource/");
   $Pipe->setResourcePath("/var/www/html/fantasyworldtoys/php-toolkit/resource/"); //change the path where your resource file is
   $Pipe->setAlias("fantasy"); //set your alias name here
