...
namespace Magebuzz\Quickview\Plugin;
...
class BlockProductList
{
        ...
        )
    {
        ...
        if ($isEnabled) {
            ...
            return $result . '<a class="magebuzz-quickview magebuzz_quickview_button" data-quickview-url=' . $productUrl . ' href="javascript:void(0);"><span>' . __("$buttonText") . '</span></a>';
        }
