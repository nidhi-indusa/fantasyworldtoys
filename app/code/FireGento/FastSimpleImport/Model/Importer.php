...
class Importer
{
    ...
    public function processImport($dataArray,$processId)
    {
        if ($this->_validateData($dataArray,$processId)) {
            $this->_importData();
			return true;
		}
		else{
    ...
    protected function _validateData($dataArray,$processId)
    {
