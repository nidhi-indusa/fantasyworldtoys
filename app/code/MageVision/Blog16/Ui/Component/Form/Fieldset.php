...
namespace MageVision\Blog16\Ui\Component\Form;
...
class Fieldset extends BaseFieldset {
    ...
    \Magento\Framework\App\Request\Http $request, \FME\GoogleMapsStoreLocator\Model\ResourceModel\Storelocator\CollectionFactory $collectionFactory, ContextInterface $context, array $components = [], array $data = [], FieldFactory $fieldFactory) {
    ...
    public function getChildComponents() {
        ...
        foreach ($store_wise_quantity as $key => $val) {
            $fields[] = array('label' => "Ax Store Id (" . $key . ")", 'value' => $val, 'formElement' => 'input');
        }
