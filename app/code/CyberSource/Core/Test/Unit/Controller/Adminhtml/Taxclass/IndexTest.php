...
class IndexTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->controller = $helper->getObject(
            \CyberSource\Core\Controller\Adminhtml\Taxclass\Index::class,
            [
    ...
    {
        $this->assertEquals(null, $this->controller->_isAllowed());
    }
    
    public function testGetResultPage()
    {
        $this->assertEquals($this->pageResultMock, $this->controller->getResultPage());
    }
}
