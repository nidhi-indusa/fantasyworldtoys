 ...
 */
namespace CyberSource\Core\Test\Unit\Block;
...
class FingerprintTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->block = $helper->getObject(
            \CyberSource\Core\Block\Fingerprint::class,
            [
    ...
    {
        $this->assertEquals('https://h.online-metrix.net/fp/tags.js?session_id=', substr($this->block->getJsUrl(), 0, 50));
    }
    
    public function testGetIframeUrl()
    {
        $this->assertEquals('https://h.online-metrix.net/fp/tags?session_id=', substr($this->block->getIframeUrl(), 0, 47));
    }
}
