...
class editTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->block = $helper->getObject(
            \CyberSource\Core\Block\Adminhtml\Taxes\Edit::class,
            [
    ...
    public function testGetHeaderText()
    {
        ...
        $this->assertEquals(__('Add Tax Class'), $this->block->getHeaderText());
        $this->assertEquals(__('Edit Tax Class \'%1\'', null), $this->block->getHeaderText());
    }
    
    public function test_prepareLayout()
    {
        $this->assertEquals($this->block, $this->block->_prepareLayout());
    }
}
