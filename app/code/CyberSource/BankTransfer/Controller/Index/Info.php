...
class Info extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if ($needUpdate || empty($data)) {
            ...
            $data = $this->_cyberSourceAPI->getListOfBanks($quote->getId(), $this->scopeConfig->getValue("payment/cybersource_bank_transfer/ideal_merchant_id", \Magento\Store\Model\ScopeInterface::SCOPE_STORE));
