...
class LoadInfoTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    protected function setUp()
    {
        ...
        $this->controller = $helper->getObject(
            \CyberSource\SecureAcceptance\Controller\Index\LoadInfo::class,
            [
    ...
    {
        $this->responseMock->decision = 'ok';
        $this->responseMock->reasonCode = 100;
        $this->responseMock->merchantReferenceCode = 1;
        $this->assertEquals($this->jsonMock, $this->controller->placeOrder($this->responseMock));
    }
}
