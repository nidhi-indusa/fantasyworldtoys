...
class LoadSilentDataTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    protected function setUp()
    {
        ...
        $this->controller = $helper->getObject(
            \CyberSource\SecureAcceptance\Controller\Index\LoadSilentData::class,
            [
    ...
    public function testExecute()
    {
        $this->scopeConfigMock->expects($this->at(0))
            ...
            ->will($this->returnCallback(function ($param, $store) {
                $this->counter++;
