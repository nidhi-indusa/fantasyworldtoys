...
class LoadIFrameTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    protected function setUp()
    {
        ...
        $this->controller = $helper->getObject(
            \CyberSource\SecureAcceptance\Controller\Index\LoadIFrame::class,
            [
    ...
    public function testExecute()
    {
        $this->helperMock
             ...
             ->with(true, null)
             ->will($this->returnValue(['request_url' => '']));
        $this->resultMock
            ->method('setUrl')
            ->willReturn('test');
        $this->storeMock
